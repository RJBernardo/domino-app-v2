<ul class="sidebar-menu" data-widget="tree">
  ...
  <li>
    <a href="<?php echo $this->Url->build('/'); ?>">
      <i class="fa fa-dashboard"></i> <span>Rankings</span>
  ...
  <li>
    <a href="<?php echo $this->Url->build('/Games/addMany'); ?>">
      <i class="fa fa-plus"></i> <span>Lançamento Online</span>
      <span class="pull-right-container">
        <small class="label pull-right bg-green">new</small>
      </span>
    </a>
  ...
  <li>
    <a href="<?php echo $this->Url->build('/Games/add'); ?>">
      <i class="fa fa-plus"></i> <span>Lançamento Manual</span>
    </a>
  </li>
  <li>
    <a href="<?php echo $this->Url->build('/Games'); ?>">
