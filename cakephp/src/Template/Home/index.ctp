...
<section class="content">
  ...
  <div class="row">
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $i= 1; foreach ($resultsDiario as $result): ?>
                        <tr>
                            <td class="padding-5"><?= h($i) ?></td>
    ...
    <section class="col-lg-6 col-md-6 connectedSortable">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Ranking Diário - Duplas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="table-responsive">
                <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $i= 1; foreach ($resultsDuplaDiario as $result): ?>
                            <tr>
                                <td class="padding-5"><?= h($i) ?></td>
                                <td class="padding-5"><?= h($result['Prim_User']) ?></td>
                                <td class="padding-5"><?= h($result['Seg_User']) ?></td>
                                <td class="text-center padding-5"><?= $this->Number->precision($result['Perc_Vit'], 2) ?> %</td>
                                <td class="text-center padding-5"><?= $this->Number->format($result['Tot_Part']) ?></td>
                                <td class="text-center padding-5"><?= $this->Number->format($result['Part_Ganhas']) ?></td>
                            </tr>
                            <?php $i++; endforeach; ?>
                        </tbody>
                    </table>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
                ...
                <tbody>
                    <?php $i = 1; foreach ($resultsSemanal as $result): ?>
                    <tr>
                        <td class="padding-5"><?= h($i) ?></td>
                        <td class="padding-5"><?= h($result['name']) ?></td>
                        <td class="text-center padding-5"><?= $this->Number->precision($result['Perc_Vit'], 2) ?> %</td>
                        <td class="text-center padding-5"><?= $this->Number->format($result['qtd_diasjogados']) ?></td>
                        <td class="text-center padding-5"><?= $this->Number->format($result['qtd_games']) ?></td>
                        <td class="text-center padding-5"><?= $this->Number->format($result['qtd_win']) ?></td>
                        <td class="text-center padding-5"><?= $this->Number->format($result['qtd_merdas']) ?></td>
                    </tr>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
                ...
                <tbody>
                    <?php $i = 1; foreach ($resultsMensal as $result): ?>
                    <tr>
                        <td class="padding-5"><?= h($i) ?></td>
                        <td class="padding-5"><?= h($result['name']) ?></td>
                        <td class="text-center padding-5"><?= $this->Number->precision($result['Perc_Vit'], 2) ?> %</td>
    ...
    <section class="col-lg-6 col-md-6 connectedSortable">
        ...
        <div class="box-body">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php $i = 1; foreach ($resultsAnual as $result): ?>
                    <tr>
                        <td class="padding-5"><?= h($i) ?></td>
                        <td class="padding-5"><?= h($result['name']) ?></td>
                        <td class="text-center padding-5"><?= $this->Number->precision($result['Perc_Vit'], 2) ?> %</td>
        ...
        <div class="box box-primary">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $i = 1; foreach ($resultsAcumulado as $result): ?>
                        <tr>
                            <td class="padding-5"><?= h($i) ?></td>
                            <td class="padding-5"><?= h($result['name']) ?></td>
                            <td class="text-center padding-5"><?= $this->Number->precision($result['Perc_Vit'], 2) ?> %</td>
    ...
    <section class="col-lg-6 col-md-6 connectedSortable">
        ...
        <!-- Ranking Acumulado - Duplas  -->
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Ranking Acumulado - Duplas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $i = 1; foreach ($resultsDuplaGeral as $result): ?>
                        <tr>
                            <td class="padding-5"><?= h($i) ?></td>
                            <td class="padding-5"><?= h($result['Prim_User']) ?></td>
                            <td class="padding-5"><?= h($result['Seg_User']) ?></td>
    ...
    <section class="col-lg-6 col-md-6 connectedSortable">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Ranking Merdas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $i = 1; foreach ($resultsMerdas as $result): ?>
                        <tr>
                            <td class="padding-5"><?= h($i) ?></td>
                            <td class="padding-5"><?= h($result['name']) ?></td>
                            <td class="text-center padding-5"><?= $this->Number->precision($result['Perc_Merdas'], 2) ?> %</td>
                            <td class="text-center padding-5"><?= $this->Number->format($result['qtd_diasjogados']) ?></td>
                            <td class="text-center padding-5"><?= $this->Number->format($result['qtd_merdas']) ?></td>
                        </tr>
                        <?php $i++; endforeach; ?>
