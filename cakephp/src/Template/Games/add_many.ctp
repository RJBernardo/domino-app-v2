            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-2">
                    <button class="btn btn btn-warning form-control" title='<?= __('Submit') ?>'
                        data-original-title='<?= __('Submit') ?>' data-toggle="tooltip" type="submit"
                        onclick="return validaPartida(2);"><i class="fa fa-check fa-fw"></i> Continuar Todos
                    </button>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-2">
                    <button class="btn btn btn-primary form-control" title='<?= __('Submit') ?>'
                        data-original-title='<?= __('Submit') ?>' data-toggle="tooltip" type="submit"
                        onclick="return validaPartida(1);"><i class="fa fa-check fa-fw"></i> Continuar Vencedores
                    </button>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-2">
                    <button class="btn btn btn-success form-control" title='<?= __('Submit') ?>'
                        data-original-title='<?= __('Submit') ?>' data-toggle="tooltip" type="submit"
                        onclick="return validaPartida(0);"><i class="fa fa-check fa-fw"></i> Salvar
                    </button>
                </div>
                <br />
                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-2">
                    ...
                    <?php foreach ($results as $result): ?>
                        <tr>
                            ...
                            <td class="text-center padding-5">
                                <?= $this->Number->precision($result['Perc_Vit'], 2) ?> %
                            </td>
                            <td class="text-center padding-5">
                                <?= $this->Number->format($result['qtd_games']) ?>
                            </td>
                            <td class="text-center padding-5">
                                <?= $this->Number->format($result['qtd_win']) ?>
                            </td>
                            <td class="text-center padding-5">
                                <?= $this->Number->format($result['qtd_merdas']) ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
